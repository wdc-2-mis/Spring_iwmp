...
public interface OutcomeMasterDao {
	...
	LinkedHashMap<Integer, List<AddOutcomeParaBean>> getOutcomeparadraft(Integer projectId, Integer month, Integer year);
	...
	LinkedHashMap<Integer,List<AddOutcomeParaBean>> getstateWiseAdditionalParameter(String fyear);
	...
	LinkedHashMap<Integer, List<AddOutcomeParaBean>> getOutcomeparacomplete(Integer project, Integer month,
			Integer financial);
}
