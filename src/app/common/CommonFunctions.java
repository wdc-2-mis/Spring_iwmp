...
//		            footer.addCell(totalPageCount);
		 ...
		 public String uploadFileMahotwavInauguration(MultipartFile mfile, String filePath, String code, String act, int seq) throws Exception
		 {
				int mid=0, k=0;
				String ext="", file_name = "", concatinate = ".";
				try {
					 ...
					 //   String mimeType = fileTypeMap.getContentType(fileName);
					  ...
					  //  application/octet-stream
						...
						if ((ext.compareToIgnoreCase("jpg") == 0)
							...
							|| (ext.compareToIgnoreCase("png") == 0)) 
						{
							file_name = "I"+code+act+seq+"_"+fileName;
						//	file_name = file_name.concat(concatinate);
							if (!file_name.equals("")) 
							{
								File fileToCreate = new File(filePath, file_name);
		 ...
		 public String uploadFileSwachhataDetails(MultipartFile mfile, String filePath, String code, String act, int seq) throws Exception
		 {
				int mid=0, k=0;
				String ext="", file_name = "", concatinate = ".";
				try {
					 ...
					 //   String mimeType = fileTypeMap.getContentType(fileName);
					  ...
					  //  application/octet-stream
						...
						if ((ext.compareToIgnoreCase("jpg") == 0)
							...
							|| (ext.compareToIgnoreCase("png") == 0)) 
						{
							file_name = "Swachhata"+code+act+seq+"_"+fileName;
						//	file_name = file_name.concat(concatinate);
							if (!file_name.equals("")) 
							{
								File fileToCreate = new File(filePath, file_name);
...
//
//		public void uploadFilePrabhatPheriMahotsav(MultipartFile image, String filePath, String code, String string,
//				int sequence) {
			 public String uploadFilePrabhatPheriMahotsav(MultipartFile mfile, String filePath, String code, int seq) throws Exception
			 {
					int mid=0, k=0;
					String ext="", file_name = "", concatinate = ".";
					try {
