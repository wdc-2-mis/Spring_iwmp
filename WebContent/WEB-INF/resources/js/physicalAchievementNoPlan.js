							...
							//	alert(data[key].unitdesc + ' kdy ');
								...
								//	alert(data[key].unitdesc + ' kdy1 ');
									...
									if($.inArray(data[key].headdesc, $head) === -1){
										$headid++;
										$activityid=1;
									$tbodyAddPhysicalAchievement.append("<tr><td>"+$headid+". "+data[key].headdesc+"</td><td>"+$headid+"."+$activityid+". "+$activity+"</td><td>"+data[key].unitdesc+"</td><td>"+data[key].qtyplanneduptoyear+"</td><td>N/A</td><td>"+((data[key].qtyplannedthisyear)+(data[key].qtyplanneduptoyear))+"</td><td>"+data[key].achievementthisyr+"</td><td>"+$achievement+"</td></tr>");
									$head.push(data[key].headdesc);
								//	alert(data[key].unitdesc + ' kdy ');
									}
									else{
									$tbodyAddPhysicalAchievement.append("<tr><td></td><td>"+$headid+"."+$activityid+". "+$activity+"</td><td>"+data[key].unitdesc+"</td><td>"+data[key].qtyplanneduptoyear+"</td><td>N/A</td><td>"+((data[key].qtyplannedthisyear)+(data[key].qtyplanneduptoyear))+"</td><td>"+data[key].achievementthisyr+"</td><td>"+$achievement+"</td></tr>");
								//	alert(data[key].unitdesc + ' kdy1 ');
									}/*}
									}*/
									$activityid++;
...
$(document).on('click', '#btnForward', function(e) {
		...
		$("#ok").click(function(){
			...
			$.ajax({  
				url:"forwardAchievementFromPIAkdy",
				type: "post", 
				...
				success:function(data) {
					if(data==='success')
					{
						...
						window.location.href='addPhysicalAchievementWithoutPlan';
					}
					else{
