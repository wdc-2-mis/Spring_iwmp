...
$( document ).ready(function(){
	...
	$(".uperror").hide();
		...
		if(d[k].status=='O')
		{
			...
			tblData+="<tr><td>"+i+"</td><td><input type='checkbox' checked  disabled='disabled' class='chkIndividual' id='chkIndividual"+d[k].assetid+"' data-id='"+i+"' name='chkIndividual"+d[k].assetid+"' value='"+d[k].assetid+"' onclick='checkBoxClicked($(this));'/></td><td><input type='hidden' id = 'assetid' name ='assetid' value="+d[k].assetid+"> "+d[k].assetid+"</td><td>"+d[k].activitydesc+"</td><td>"+d[k].bname+"</td><td>"+d[k].vname+"</td><td><input type='text' class='disable'  size='10' id='datepicker"+i+"' value = "+d[k].sdate+" name='sdate"+d[k].assetid+"' readonly='readonly'  autocomplete = 'off'/></td><td style='white-space: nowrap;'><input type='hidden' name ='statusid' value="+d[k].statusid+"><input type='radio' class='onGoing' name = 'status"+d[k].assetid+"' value='O' data-id='"+i+"' id='onGoing' checked='checked'>OnGoing<input type='radio' class='complete"+i+"' value='C' data-id='"+i+"' name = 'status"+d[k].assetid+"' id='complete'>Complete<input type='radio' data-id='"+i+"' value='F' class='forClose"+i+"' name = 'status"+d[k].assetid+"' id='forClose'>ForClosed</td><td><input type='text' class='datepicker'  size='10' id='cdatepicker"+i+"'  name='cdate"+d[k].assetid+"' disabled='disabled' required='required' autocomplete = 'off'/></td><td><textarea rows='4' size='15' height='25' disabled='disabled' name='reason"+d[k].assetid+"' id='reason"+i+"'  required='required' autocomplete = 'off'></textarea></td></tr>";
		    }else
			tblData+="<tr><td>"+i+"</td><td><input type='checkbox' checked  disabled='disabled' class='chkIndividual' id='chkIndividual"+d[k].assetid+"' data-id='"+i+"' name='chkIndividual"+d[k].assetid+"' value='"+d[k].assetid+"' onclick='checkBoxClicked($(this));'/></td><td><input type='hidden' id = 'assetid' name ='assetid' value="+d[k].assetid+">"+d[k].assetid+"</td><td>"+d[k].activitydesc+"</td><td>"+d[k].bname+"</td><td>"+d[k].vname+"</td><td><input type='text' class='disable'  size='10' id='datepicker"+i+"' value = "+d[k].sdate+" name='sdate"+d[k].assetid+"' readonly='readonly'   autocomplete = 'off'/></td><td style='white-space: nowrap;'><input type='hidden' name ='statusid' value="+d[k].statusid+"><input type='radio' class='onGoing' name = 'status"+d[k].assetid+"' value='O' data-id='"+i+"' id='onGoing' checked='checked'>OnGoing<input type='radio' class='complete"+i+"' value='C' data-id='"+i+"' name = 'status"+d[k].assetid+"' id='complete'>Complete<input type='radio' data-id='"+i+"' value='F' class='forClose"+i+"' name = 'status"+d[k].assetid+"' id='forClose'>ForClosed</td><td><input type='text' class='datepicker'  size='10' id='cdatepicker"+i+"'  name='cdate"+d[k].assetid+"' disabled='disabled' required='required' autocomplete = 'off'/></td><td><textarea rows='4' size='15' height='25' disabled='disabled' name='reason"+d[k].assetid+"' id='reason"+i+"'  required='required' autocomplete = 'off'></textarea></td></tr>";
		    i++
		 ...
		 /*if(d[k].status=='C')
			...
			{
			if(parseInt(k)===0){
			tblData+="<tr><td>"+i+"</td><td><input type='checkbox' class='chkIndividual' id='chkIndividual"+d[k].assetid+"' data-id='"+i+"' name='chkIndividual"+d[k].assetid+"' value='"+d[k].assetid+"'/></td><td><input type='hidden' id = 'assetid' name ='assetid' value="+d[k].assetid+"> "+d[k].assetid+"</td><td>"+d[k].activitydesc+"</td><td>"+d[k].bname+"</td><td>"+d[k].vname+"</td><td><input type='text' class='datepicker'  size='10' id='sdatepicker"+i+"'  data-id='"+i+"' name='sdate"+d[k].assetid+"' required disabled autocomplete = 'off'/></td><td style='white-space: nowrap;'><input type='radio' class='onGoing' name = 'status"+d[k].assetid+"' value='O' data-id='"+i+"' id='onGoing' checked='checked'>OnGoing<input type='radio' class='complete"+i+"' value='C' data-id='"+i+"' name = 'status"+d[k].assetid+"' id='complete'>Complete<input type='radio' data-id='"+i+"' value='F' class='forClose"+i+"' name = 'status"+d[k].assetid+"' id='forClose'>ForClosed</td><td><input type='text' class='datepicker'  size='10' id='cdatepicker"+i+"' name='cdate"+d[k].assetid+"' disabled  autocomplete = 'off' required/></td><td><textarea rows='4' size='15' height='25' name='reason"+d[k].assetid+"' id='reason"+i+"' readonly='readonly' required='required' autocomplete = 'off'></textarea> </td></tr>";
		    }else
			tblData+="<tr><td>"+i+"</td><td><input type='checkbox' class='chkIndividual' id='chkIndividual"+d[k].assetid+"' data-id='"+i+"' name='chkIndividual"+d[k].assetid+"' value='"+d[k].assetid+"'/></td><td><input type='hidden' id = 'assetid' name ='assetid' value="+d[k].assetid+">"+d[k].assetid+"</td><td>"+d[k].activitydesc+"</td><td>"+d[k].bname+"</td><td>"+d[k].vname+"</td><td><input type='text' class='datepicker' size='10' id='sdatepicker"+i+"' data-id='"+i+"'  name='sdate"+d[k].assetid+"' required disabled autocomplete = 'off'/></td><td style='white-space: nowrap;'><input type='radio' class='onGoing' name = 'status"+d[k].assetid+"' value='O' data-id='"+i+"' id='onGoing' checked='checked'>OnGoing<input type='radio' class='complete"+i+"' value='C' data-id='"+i+"' name = 'status"+d[k].assetid+"' id='complete'>Complete<input type='radio' data-id='"+i+"' value='F' class='forClose"+i+"' name = 'status"+d[k].assetid+"' id='forClose'>ForClosed</td><td><input type='text' class='datepicker'  size='10' id='cdatepicker"+i+"' name='cdate"+d[k].assetid+"' disabled autocomplete = 'off' required/></td><td><textarea rows='4' size='15' height='25' name='reason"+d[k].assetid+"' id='reason"+i+"' readonly='readonly' required='required' autocomplete = 'off'></textarea> </td></tr>";
		    i++
	...
	$tbodyassetWiseHeadStatusId.append(tblData);
		...
		if(d[k].status=='O')
		{
			...
			{
			if(parseInt(k)===0){
			tblData+="<tr><td>"+i+"</td><td><input type='checkbox' class='chkIndividual' id='chkIndividual"+d[k].assetid+"' data-id='"+i+"' name='chkIndividual"+d[k].assetid+"' value='"+d[k].assetid+"'/></td><td><input type='hidden' id = 'assetid' name ='assetid' value="+d[k].assetid+"> "+d[k].assetid+"</td><td>"+d[k].activitydesc+"</td><td>"+d[k].bname+"</td><td>"+d[k].vname+"</td><td><input type='text' class='datepicker'  size='10' id='sdatepicker"+i+"'  data-id='"+i+"' name='sdate"+d[k].assetid+"' required disabled autocomplete = 'off'/></td><td style='white-space: nowrap;'><input type='radio' class='onGoing' name = 'status"+d[k].assetid+"' value='O' data-id='"+i+"' id='onGoing' checked='checked'>OnGoing<input type='radio' class='complete"+i+"' value='C' data-id='"+i+"' name = 'status"+d[k].assetid+"' id='complete'>Complete<input type='radio' data-id='"+i+"' value='F' class='forClose"+i+"' name = 'status"+d[k].assetid+"' id='forClose'>ForClosed</td><td><input type='text' class='datepicker'  size='10' id='cdatepicker"+i+"' name='cdate"+d[k].assetid+"' disabled='disabled' required autocomplete = 'off'/></td><td><textarea rows='4' size='15' height='25' name='reason"+d[k].assetid+"' id='reason"+i+"' readonly='readonly' required autocomplete = 'off'></textarea> </td></tr>";
		    }else
			tblData+="<tr><td>"+i+"</td><td><input type='checkbox' class='chkIndividual' id='chkIndividual"+d[k].assetid+"' data-id='"+i+"' name='chkIndividual"+d[k].assetid+"' value='"+d[k].assetid+"'/></td><td><input type='hidden' id = 'assetid' name ='assetid' value="+d[k].assetid+">"+d[k].assetid+"</td><td>"+d[k].activitydesc+"</td><td>"+d[k].bname+"</td><td>"+d[k].vname+"</td><td><input type='text' class='datepicker' size='10' id='sdatepicker"+i+"' data-id='"+i+"'  name='sdate"+d[k].assetid+"' required disabled autocomplete = 'off'/></td><td style='white-space: nowrap;'><input type='radio' class='onGoing' name = 'status"+d[k].assetid+"' value='O' data-id='"+i+"' id='onGoing' checked='checked'>OnGoing<input type='radio' class='complete"+i+"' value='C' data-id='"+i+"' name = 'status"+d[k].assetid+"' id='complete'>Complete<input type='radio' data-id='"+i+"' value='F' class='forClose"+i+"' name = 'status"+d[k].assetid+"' id='forClose'>ForClosed</td><td><input type='text' class='datepicker'  size='10' id='cdatepicker"+i+"' name='cdate"+d[k].assetid+"' disabled='disabled' required autocomplete = 'off'/></td><td><textarea rows='4' size='15' height='25' name='reason"+d[k].assetid+"' id='reason"+i+"' readonly='readonly' required autocomplete = 'off'></textarea> </td></tr>";
		    i++
