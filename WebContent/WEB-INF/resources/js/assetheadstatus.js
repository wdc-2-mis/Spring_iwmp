...
var strdate = $("#sdatepicker"+id).val();

 $(document).on('focus', '.datepicker', function(e){ 
	$(this).datepicker({
    	 changeMonth: true,
         changeYear: true,
         minDate: id!=0 && strdate ? new Date($.datepicker.parseDate('dd-mm-yy',$("#sdatepicker"+id).val())) : new Date(2022, 3, 1), // 01-04-2022 (months are 0-based, so 3 = April)
         maxDate: date,
         dateFormat: "dd-mm-yy",
         yearRange: "2022:2041",
         onClose: function(){
