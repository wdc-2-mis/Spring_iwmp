...
<div class="container mt-2">
 <!--  <h2>Toggleable Tabs</h2>
  ...
  <ul class="nav nav-tabs">
    <li class="nav-item">
      <a class="nav-link active" id="createPhysicalAnnualActionPlan" data-toggle="tab" href="#physicalAnnualActionPlan">Add/View Physical Annual Action Plan</a>
    </li>
  ...
  <div class="tab-content">
    <div id="physicalAnnualActionPlan" class="container tab-pane active"><br>
      <h3>Add Activities of Physical Action Plan to Complete Project</h3>
...
<div class="form-group col-6"></div>
  ...
  <div class="form-row">
     ...
     <thead><tr><th>Name of Head</th><th>Name of Activity</th><th>Unit</th><th class="text-center"><span >Plan</span><br/>Quantity/ Area to be developed</th></tr></thead>
...
<script src='<c:url value="/resources/js/physicalactionplanexist.js" />'></script>
</body>
</html>