...
<title>Report WP1 - Project-wise Watershed Punarutthan Details</title>
...
function downloadPDF(dcode, dName, stName){
	...
	document.getProjPunarutthan.action="downloadPDFProjPunarutthanRpt";
	document.getProjPunarutthan.method="post";
	document.getProjPunarutthan.submit();
}
...
function exportExcel(dcode, dName, stName){
    ...
    document.getElementById("dName").value=dName;
    document.getElementById("stName").value=stName;
	document.getProjPunarutthan.action="downloadExcelProjPunarutthanRpt";
	document.getProjPunarutthan.method="post";
	document.getProjPunarutthan.submit();
}
...
<div class="maindiv">
    <div class="offset-md-3 col-6 formheading" style="text-align: center;">
        <h5>Report WP1 - Project-wise Watershed Punarutthan Details</h5>
    </div>
    <br>
    <div class ="card">
		<div class="row">
			...
			<div class="col-10">
			<br>
    <c:if test="${not empty punarutthanRptProjDataList}">
    ...
    <p align="right"> Report as on: <%=app.util.Util.dateToString(null,"dd/MM/yyyy hh:mm aaa")%> </p>
        ...
        <form action="downloadExcelProjPunarutthanRpt" name="getProjPunarutthan" id="getProjPunarutthan" method="post">
        
        			<input type="hidden" name="dcode" id="dcode" value="" />
                    <input type="hidden" name="dName" id="dName" value="" />
                    <input type="hidden" name="stName" id="stName" value="" />
                    
                <table class="table" id="projPunarutthan" >
                    <thead>
                    	 <tr>
                             <th colspan="13">State Name : ${stName}, &nbsp;&nbsp; District Name: ${dName}</th>
                         </tr>
                        <tr>
                      ...
                      <tbody id="tbodyProjPunarutthan">
						...
						<c:if test="${punarutthanRptProjDataListSize>0}">
							<tr>
