...
<title>Report WP1 - District-wise Watershed Punarutthan Details</title>
...
function downloadPDF(stcd, stName){
	...
	document.getDistPunarutthan.action="downloadPDFDistPunarutthanRpt";
	document.getDistPunarutthan.method="post";
	document.getDistPunarutthan.submit();
}

function exportExcel(stcd, stName){
	document.getElementById("stcd").value=stcd;
	document.getElementById("stName").value=stName;
	document.getDistPunarutthan.action="downloadExcelDistPunarutthanRpt";
	document.getDistPunarutthan.method="post";
	document.getDistPunarutthan.submit();
}
...
<div class="maindiv">
    <div class="offset-md-3 col-6 formheading" style="text-align: center;">
        <h5>Report WP1 - District-wise Watershed Punarutthan Details</h5>
    </div>
    <br>
    <div class ="card">
		<div class="row">
			...
			<div class="col-10">
			<br>
    <c:if test="${not empty punarutthanRptDistDataList}">
    ...
    <p align="right"> Report as on: <%=app.util.Util.dateToString(null,"dd/MM/yyyy hh:mm aaa")%> </p>
        ...
        <form action="downloadExcelDistPunarutthanRpt" name="getDistPunarutthan" id="getDistPunarutthan" method="post">
        
        <input type="hidden" name="stcd" id="stcd" value="" />
		<input type="hidden" name="stName" id="stName" value="" />
		
                <table class="table" id="distPunarutthan" >
                    <thead>
                    	<tr>
                      ...
                      <tbody id="tbodyDistPunarutthan">
						<c:forEach items="${punarutthanRptDistDataList}" var="dt" varStatus="sno">
							<tr>
								<td class="text-left"><c:out value="${sno.count}" /></td>
<%-- 								<td class="text-left"><c:out value="${dt.distname}" /></td> --%>
								<td><a href = "getProjPunarutthanReport?distcd=${dt.dcode}&dName=${dt.distname}&stName=${stName}"><c:out value='${dt.distname}'/></a></td>
						...
						<c:if test="${punarutthanRptDistDataListSize>0}">
							<tr>
