...
<body>
	<div class="maindiv">
		<div class="col" style="text-align: center;">
			<h4>
				<u>Unfreeze PFMS Mapping With WorkId</u>
			</h4>
		</div>
		<form:form autocomplete="off" name="unfreezePfmsMappingWithWorkId"
			id="unfreezePfmsMappingWithWorkId" action="unfreezePfmsMappingWithWorkId"
			method="get">
			...
			<table>
				<tr>
					...
					<td class="label">Financial Year &nbsp;<span
						style="color: red;">*</span></td>
					<td><td><span class="yearError"></span>
