 ...
 <!--  <h2>Toggleable Tabs</h2>
  ...
  <ul class="nav nav-tabs">
   ...
   <%--  <li class="nav-item">
    ...
    <li class="nav-item">
      <a class="nav-link" id="viewAssetCreatedkd" data-toggle="tab" href="#assetCreated">List of Work-Id already approved by SLNA</a>
    </li>
  ...
  <div class="tab-content">
    ...
    <!--  <h5 class="text-center font-weight-bold"><u> List of Activities With Asset Id</u></h5> -->
     ...
     <thead><tr><th><input type="checkbox" id="chkSelectAll" name="chkSelectAll" />Select All</th><th>Project</th><th>Fin. Yr.</th><th>Temporary Work-Id</th><th>Name of Activity</th><th>Block</th><th class="text-center">Village</th><th>Activity Type</th><th>Land Identification</th><th>Remarks</th><th>Action</th></tr></thead>
    ...
    <td><input type="checkbox" class="chkIndividual" id="chkIndividual${asset.tempassetid}" name="chkIndividual${asset.tempassetid}" value="${asset.tempassetid}"/></td>
     ...
     <td><c:out value="${asset.nearby}" /></td>
     <td><textarea maxlength="1000" id="remarks${asset.tempassetid}" name="remarks${asset.tempassetid}" class="remarks"></textarea></td>
     <td width=15%><span><a href="#" data-id="${asset.tempassetid }" class="forwardLink">  <c:if test="${userType ne 'DI'}">Complete</c:if>  <c:if test="${userType eq 'DI'}">Forward</c:if></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" data-id="${asset.tempassetid }" class="rejectLink">Reject</a></span></td> 
     </tr>
   ...
   <br/>
    ...
    <option value="0">--All--</option>
     ...
     <div class="form-group col-1">
      <label for="project"> &nbsp;</label>
     <button class="btn btn-info" id="getForwardedAsset" name="getForwardedAsset" >Get Forwarded Work-Id</button>
     </div>
     </div>
     <div class="form-row">
    ...
    <!--  <h5 class="text-center font-weight-bold"><u>Forwarded List of Activity With Temp. Asset Id</u></h5> -->
     ...
     <thead><tr><th>Project</th><th>Year</th><th>Temporary Work Id</th><th>Name of Activity</th><th>Block</th><th class="text-center">Village</th><th>Activity Type</th><th>Land Identification</th><th>Currently at</th></tr></thead>
   ...
   <p>Note:- Temporary Work-Id is just for reference purpose. It would be deleted and New Work-Id would be provided after completion of Work by the SLNA.</p>
    ...
    <div id="rejectedAsset" class="container tab-pane fade"><br>
      <h3>Rejected List of Work-Id </h3>
      <p>Note:- You can find/ re-submit rejected asset under the <strong>Pending List Of Work-Id</strong> tab </p>
      <hr/>
     <div class="form-row">
     <div class="form-group col-12 confirmation">
    <!--  <h5 class="text-center font-weight-bold"><u>Forwarded List of Activity With Temp. Asset Id</u></h5> -->
     <table class="rejectedListActivityAssetId" id="rejectedListActivityAssetId" name="rejectedListActivityAssetId" style="width:100%">
    <thead><tr><th>Project</th><th>Year</th><th>Temporary Work-Id</th><th>Name of Activity</th><th>Block</th><th class="text-center">Village</th></tr></thead>
    ...
    <label for="project">District: </label>
    <select class="form-control project" id="districtslna" name="districtslna" >
    <option value="0">--ALL--</option>
  ...
  <c:if test='${sessionScope.userType=="DI"}'>
  <div class="form-group col-md-6">
    <label for="year">Projects: </label>
    <select class="form-control block" id="diproject" name="diproject">
      <option value="">--Select--</option>
   <c:forEach items="${getproject}" var="district">
							<option value="<c:out value="${district.key}"/>"><c:out
									value="${district.value}" /></option>
						</c:forEach>
     ...
     <table class="finalListActivityAssetId" id="finalListActivityAssetId" name="finalListActivityAssetId" style="width:100%">
     <thead><tr><th>S No.</th><th>Project Name</th><th>Fin-Year</th><th>Work-Id</th><th>Name of Activity</th><th>Block</th><th class="text-center">Village</th><th>Activity Type</th><th>Land Identification</th></tr></thead>
