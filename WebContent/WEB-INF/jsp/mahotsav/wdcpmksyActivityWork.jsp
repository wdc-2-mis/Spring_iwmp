...
<div class="registration-container">
    <h4 class="text-center mb-4 text-primary">List of WDC-PMKSY Activities or Works</h4>
    
    <form id="registrationForm" action="otherMahotsav" method="post">
    
    <table id="tblReport" cellspacing="0" class="table" width="auto" border="1">
		<thead>
			 <tr> 
			 	 <th style="text-align:center; vertical-align: middle;">S.No.</th>
      			 <th style="text-align:center; vertical-align: middle;">State Name</th> 
                 <th style="text-align:center" >Activity Work</th>
			</tr>
    	</thead>
    	
    	<c:forEach items="${stateList}" var="lists" varStatus="count">
    	<tr>
    		<td> <c:out value='${count.count}' /></td>
    		<td><c:out value="${lists.value}" /></td>
			<td style="text-align:center; vertical-align: middle;"><a href="wdcpmksyActivityWorkOpen?state=${lists.key}" target="_blank">Works</a></td>
		</tr>	
		</c:forEach>	
