	...
	<div class="card m-2">
		<div class="card-header text-white bg-secondary"
			...
			<img src="assets/images/Success-Stories.png" alt="" class=""
				style="height: 24px;"> Success Stories
		</div>
				...
				<div class="carousel-inner" style="height: 100%">
					...
					<ul class="list-group list-group-flush" id="marquee-vertical">
						<c:forEach var="list" items="${stories}">
										...
										<a href="successStories?path=${list.path.replace('\\', '/')}&&name=${list.fileName}&&subject=${list.subject}" onclick="showPdf('FileServlet?path=${list.path}/${list.fileName}','${list.subject}');"><c:out value="${list.subject }"></c:out></a>
										</li>
							</c:forEach>
...
<%-- <div class="col-md-3 col-6" style="padding: 1%">
					<div class="img-hover-zoom--slowmo">
						<img class="img-fluid img-thumbnail"
							...
							alt="">
						<div class="overlay">
							<a href="<c:url value="/resources/images/footer/nic-logo.jpg" />" class="icon" title="View">
...
<script src='<c:url value="resources/js/1.53pdfmake.min.js" />'></script>
<script src='<c:url value="resources/js/1.53vfs_fonts.js" />'></script>
<script src='<c:url value="resources/js/1.7.1buttons.html5.min.js" />'></script></script>
