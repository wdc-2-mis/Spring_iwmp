...
<div class="col formheading" style=""><h4><b>Add Depth of Ground water</b></h4> </div>
    <hr/>
    <label class="errormessage"></label>
    
    
<form:form class="form-inline" autocomplete="off" id="gwtform" name="gwtform" action="gwtDetaildata" method="post" >
  ...
  <div class="form-group col-md-3">
   ...
   <div class="form-group col-md-3 ">
    	<label for="year" class="d-none year"><b> Financial Year </b>  &nbsp;</label>
 	...
 	<tr>
	  ...
	  <tr>
	  	...
	  	<td><input type="text" size="8" id="ph" name="ph" class="form-control input" onmousedown="decimalCheck(event);" maxlength="5" placeholder="Decimal Value" /></td>
	   	<td><input type="text" size="8" id="alkalinity" name="alkalinity" class="form-control input" onmousedown="numericOnly(event);" maxlength="8" placeholder="Number Value"/></td>
	   	<td><input type="text" size="8" id="hardness" name="hardness" class="form-control input" onmousedown="numericOnly(event);" maxlength="5" placeholder="Number Value"/></td>
	   	<td><input type="text" size="8" id="calcium" name="calcium" class="form-control input" onmousedown="numericOnly(event);" maxlength="5" placeholder="Number Value"/></td>
	   	<td><input type="text" size="8" id="chloride" name="chloride" class="form-control input" onmousedown="numericOnly(event);" maxlength="5" placeholder="Number Value"/></td>
	   	...
	   	<td><input type="text" size="8" id="dissolved" name="dissolved" class="form-control input" onmousedown="numericOnly(event);" maxlength="5" placeholder="Number Value"/></td>
...
<script src='<c:url value="/resources/js/groundwatertable.js" />'></script>
...
function do_Delete(gwtid, gwtdtid, projid) 
{
	...
	{
			document.gwtform.action="deleteGWTdraft";
...
function do_Lock(gwtid, gwtdtid, projid) 
{
	...
	{
			document.gwtform.action="completeGWTDraftData";
			document.gwtform.method="post";
			document.gwtform.submit();
	}
}
