...
<div class="container">
<div class="col" style="text-align:center;"><h5>Add Outcome Achievement</h5></div>
  <form name="addOutcomeAchievement" id="addOutcomeAchievement">
    ...
    <!--  <h5 class="text-center font-weight-bold"><u>Forwarded List of Activity With Temp. Asset Id</u></h5> -->
     ...
     <thead><tr><th rowspan="2" class="text-center">Name of Head</th><th rowspan="2" class="text-center">Name of Activity</th><th colspan="5" class="text-center">Achievement</th></tr>
     ...
     <tbody id="tbodyAddOutcomeAchievement"></tbody>
     </table>
     </div>
  </div>
  <div class="form-row">
