...
function validation() 
{
	...
	/* if(document.getElementById("theFile").value == "") 
	{
		alert("Please select correct file for given format!");
		document.getElementById("theFile").focus();
		return;  
	} */
	...
	document.useruploadsl.action="saveUserUploadDetailSLNA";
	document.useruploadsl.method="post";
	document.useruploadsl.submit();
...
function updateUploadDetail(index, FileName, sub, captioncheckstatus, publishcheckstatus, cat, id) 
{
	...
	else if (confirm("It will update the Data.\n\n Do you want to continue ?") == true) 
	{
		...
		document.useruploadsl.action="updateUserUploadDetailSLNA";
		document.useruploadsl.method="post";
		document.useruploadsl.submit();
	}
}
...
function do_Delete(index, FileName, subject, id) 
{
	...
	if (confirm("It will delete the Data.\n\n Do you want to continue ?") == true) 
	{
		if (confirm("It will delete uploaded file also.If you want to continue,Press OK button") == true) 
		{
			...
			document.useruploadsl.action="deleteUserUploadDetailSLNA";
			document.useruploadsl.method="post";
			document.useruploadsl.submit();
		}
	}
...
<div class="col" style="text-align:center;"><h5>Uploading of Best Practices/Innovations/Case Studies  for Knowledge Sharing</h5></div>
...
<!-- 	
 ...
 <form:form autocomplete="off" name="useruploadsl" id="useruploadsl" action="saveUserUploadDetailSLNA" modelAttribute="useruploadsl" enctype="multipart/form-data">
      ...
      <table>
        ...
        <tr> 
          	...
          	&nbsp;&nbsp;  <span class="filletyp" style="color: red;">(*Note:File type Only .doc,.docx,.ppt,.pptx,.jpg,.jpeg,.pdf,.xls,.xlsx supported) </span>
        ...
        <tr>
			...
			<td width="12%">
			 ...
			 <b>New Caption</b>&nbsp;&nbsp;<input type="checkbox" name="New_File" id="New_File"></input></td>
        </tr>
        <tr>
