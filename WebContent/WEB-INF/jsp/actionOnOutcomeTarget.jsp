...
<div class="container mt-2">
 ...
 <ul class="nav nav-tabs">
    <li class="nav-item">
      <a class="nav-link active" id="createPhysicalAnnualActionPlan" data-toggle="tab" href="#approvalRejection">Approval/Rejection of Outcome Target</a>
    </li>
  ...
  <div id="approvalRejection" class="container tab-pane active"><br>
     <h3>Approval/Rejection of Outcome Target</h3>
     <hr/>
      <table class="achievement" id="aapAchievement" name="aapAchievement">
     <thead><tr><th>Project</th><th>Year</th><th>Status</th><th>Currently at Level</th><th >Remarks</th><th >Action</th></tr></thead>
     ...
     <td><a href="#" data-id="${projList.targetid }" class="action" id="action" name="action">Action</a></td>
     </tr>
		</c:forEach>
   ...
   <div id="movement" class="container tab-pane fade"><br>
     ...
     <thead><tr><th>Project</th><th>Year</th><th>Status</th><th>Currently at Level</th><th >Remarks</th><th>View Target Detail</th><th>View Target Movement</th></tr></thead>
