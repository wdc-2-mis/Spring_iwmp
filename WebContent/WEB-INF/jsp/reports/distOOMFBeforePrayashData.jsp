...
<html>
<title>Report ME7- District and Activities Wise OOMF Before Pushing Data</title>
	<script type="text/javascript">
	
	function downloadPDF(stcd, stName){
		document.getElementById("stcd").value=stcd;
		document.getElementById("stName").value=stName;
		document.OOMFDistActivities.action="downloadPDFDistOOMFBeforePrayashData";
		document.OOMFDistActivities.method="post";
		document.OOMFDistActivities.submit();
	}

	function exportExcel(stcd, stName){
			document.getElementById("stcd").value=stcd;
			document.getElementById("stName").value=stName;
			document.OOMFDistActivities.action="downloadExcelDistOOMFBeforePrayashData";
			document.OOMFDistActivities.method="post";
			document.OOMFDistActivities.submit();
	}
...
<body>
<br>
<div class="offset-md-3 col-6 formheading" style="text-align:center;"  ><h5><label id="head">Report ME7- District and Activities Wise Current Achievement for the Financial Year '<c:out value='${finyr}' />' and Month '<c:out value='${month}' />' for State '<c:out value='${stName}' />' </label></h5></div>
<br>
<div class ="card">
	...
	<form action="getOOMFBeforePrayashData" method="post" id="OOMFDistActivities" name="OOMFDistActivities">
