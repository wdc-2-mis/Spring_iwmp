...
<div class="offset-md-3 col-6 formheading" style="text-align:center;"  ><h5>Report ME9- Activity and Financial Year Wise Work Status</h5></div>
	 			...
	 			<c:if test="${dataList != null}">
						...
						<c:forEach items="${dataList}" var="data" varStatus="count">
 							<tr>
								...
								<td><c:out value="${data.projcount}" /></td>
								<td><c:out value="${data.area_proposed}" /></td>
