...
// 	document.getElementById("finName").value=finName;
	...
	document.getConvergedProjWorks.action="downloadPDFConvergedProjWorks";
	document.getConvergedProjWorks.method="post";
	document.getConvergedProjWorks.submit();
}
...
// 	document.getElementById("finName").value=finName;
	...
	document.getElementById("stName").value=stName;
	document.getElementById("distName").value=distName;
	document.getConvergedProjWorks.action="downloadExcelConvergedProjWorks";
	document.getConvergedProjWorks.method="post";
	document.getConvergedProjWorks.submit();
}
...
<div class="table-responsive" id="exportHtmlToPdf1">
 ...
 <form:form action="getConvergedProjWorks" name="getConvergedProjWorks" id="getConvergedProjWorks" method="get">
<!-- 	<div id="waitDiv"  -->
...
<br>
	...
	<br/>
	<br/>
	 <c:if test="${not empty ConvergedProjWorksList}">
...
<table id = "tblReport" class = "table">
	<thead>
		<tr>
			<th colspan=18 class="text-left">State : ${stName} &emsp; District : ${distName}</th>
		</tr>
		<tr>
	...
	<tbody id = "convergedWorksRptTbody">
		...
		<c:forEach items="${ConvergedProjWorksList}" var="work" varStatus="sno">
			<tr>
					<td class="text-left"><c:out value="${sno.count}" /></td>
					<c:if test="${work.convergedworks eq 0}">
						<td class="text-left"><c:out value="${work.proj_name}" /></td>
					</c:if>
					<c:if test="${work.convergedworks > 0}">
						<td><a href = "getConvergedProjDetailWorks?projid=${work.proj_id}&stName=${stName}&distName=${distName}"><c:out value='${work.proj_name}' /></a></td>
					</c:if>
		...
		<c:if test="${ConvergedProjWorksListSize==0}">
			<tr>
