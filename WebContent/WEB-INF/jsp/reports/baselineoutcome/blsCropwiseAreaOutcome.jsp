...
<head>
<title>Report O7-State wise Distribution of Area According to Crop Type as On Date</title>
<script type="text/javascript">

function downloadPDF()
{
		
		document.getrpt.action="downloadblcropPDF";
...
function exportExcel()
{
		...
		document.getrpt.action="downloadExcelblscrpwiseareaoutdtlrpt";
		document.getrpt.method="post";
		document.getrpt.submit();
...
// 	var reportName = "Report O7-State wise Crop Details of Baseline Outcome";
// 	var fileName="Report O7-State wise Crop Details of Baseline Outcome";
...
<form action="downloadblcropPDF" method="post" name="getrpt"></form>

<div class="container-fluid">
	<div class="offset-md-3 col-6 formheading" style="text-align: center;">
		<h5>Report O7-State wise Distribution of Area According to Crop Type as On Date</h5>
	</div>
	<button name="exportExcel" id="exportExcel" onclick="exportExcel()"	class="btn btn-info">Excel</button>
	<button name="exportExcel" id="exportExcel" onclick="downloadPDF()"	class="btn btn-info">PDF</button>
	...
	<table id="tblReport" class="table">
		...
		<tbody id="stwiseAreaRptTbody">
			...
			<c:forEach items="${stwiseAreaOutcomeDtlList}" var="project" varStatus="sno">
				<tr>
...
<td><a
						href="distblscrpwiseareaoutdtlrpt?stcode=<c:out value="${project.stcode}"/>"><c:out
								value="${project.stname}" /></a></td>
