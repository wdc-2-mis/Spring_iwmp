...
<head>
<title>Report SB4 - Project wise Distribution of Area According to Crop Type as per Baseline Survey</title>
</head>
...
function downloadPDF(stateName,distName,projId){
	...
	document.rptProjWiseBls.action="downloadblsProjectWisecropAreaSurveyPDF";
...
function exportExcel(stateName,distName,projId){
	...
	document.getElementById("distName").value=distName;
	document.getElementById("projId").value=projId;
	document.rptProjWiseBls.action="downloadExcelProjectWiseCropAreaSrvy";
	document.rptProjWiseBls.method="post";
	document.rptProjWiseBls.submit();
}
...
<div class="container-fluid">
	<div class="offset-md-3 col-6 formheading" style="text-align: center;">
		<h5><label id="head1">Report SB4 - Project wise Distribution of Area According to Crop Type as per Baseline Survey for District  ' <c:out value="${distName}" />'</label></h5>
	</div>
	<form action="downloadblsProjectWisecropAreaSurveyPDF" method="post" id="getProjWiseBls" name="rptProjWiseBls">
			<div class="form-row">
	...
	<table id="pdfBasicExample" class="table">
		<thead>
			<tr>
			<th class="text-left" colspan="2">State: <c:out value="${stateName}"/> </th>
		...
		<tbody id="dtBasicExample">
			...
			<c:forEach items="${projectList}" var="project" varStatus="sno">
				<tr>
					...
					<td class="text-right"><c:out value="${project.projname}" /></td>
