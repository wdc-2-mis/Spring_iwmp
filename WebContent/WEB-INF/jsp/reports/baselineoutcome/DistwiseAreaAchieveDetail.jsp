...
<head>
<title>Report O6- District wise Distribution of Area According to Irrigation Status, Ownership Status, Land Classification and No of Crops as On Date</title>
</head>
...
function downloadPDF(stateName, stcode)
{
		...
		document.getblsprpt.action="downloadDistWiseAreaAchvDetailPDF";
...
function exportExcel(stateName, stcode)
{
	document.getElementById("stateName").value=stateName;
	document.getElementById("stcode").value=stcode;
	document.getblsprpt.action="downloadExcelDistAreaAchvDetail";
	document.getblsprpt.method="post";
	document.getblsprpt.submit();
}
	
	</script>
<form action="downloadDistWiseAreaAchvDetailPDF" method="post" name="getblsprpt">
...
<div class="container-fluid">
	<div class="offset-md-3 col-6 formheading" style="text-align: center;">
		<h5><label id="head1">Report O6- District wise Distribution of Area According to Irrigation Status, Ownership Status, Land Classification and No of Crops as On Date</label></h5>
	</div>
...
<!-- 	<tbody id="dtBasicExample"> -->
		<thead>
			...
			<c:forEach items="${distAchList}" var="project" varStatus="sno">
				<tr>
					<td class="text-center"><c:out value="${sno.count}" /></td>
					<td><a
						href="projwiseAreaAchieveDetail?dcode=<c:out value="${project.dcode2}"/>"><c:out
