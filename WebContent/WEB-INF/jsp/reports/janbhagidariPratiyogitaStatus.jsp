...
<html>
<title>Report JP2- State wise Current Status of Watershed Janbhagidari</title>
	<script type="text/javascript">
	function exportExcel(){
		document.getJanbhagidariStatus.action="ExcelJanbhagidariStateWiseCurrentStatus";
	...
	{
			document.getJanbhagidariStatus.action="JanbhagidariStatewiseCurrentStatusPDF";
			document.getJanbhagidariStatus.method="post";
			document.getJanbhagidariStatus.submit();
...
<body>
<br>
<div class="offset-md-3 col-6 formheading" style="text-align:center;"  ><h5><label id="head">Report JP2- State wise Current Status of Watershed Janbhagidari</label></h5></div>
<br>
<div class ="card">
	...
	<div class="col-1" ></div>
	<div class="col-10" >
	<form action="getJanbhagidariStatus" method="post" id="getJanbhagidariStatus" name="getJanbhagidariStatus">
			<div class="form-row">
			</div>
		</form>
