...
<html>
<title>Report ME6- State wise Current Status of OOMF Project Activities</title>
	<script type="text/javascript">
	function exportExcel(){
		document.OOMFProjectActivities.action="getOOMFCurrentStatusReportExcel";
	...
	{
			document.OOMFProjectActivities.action="getOOMFCurrentStatusReportPDF";
			document.OOMFProjectActivities.method="post";
			document.OOMFProjectActivities.submit();
