...
<title>Report GT1- Project-wise Total No. of Work Code Shared with NRSC for Geo References</title>

<script type="text/javascript">

function exportPDF(dcode, dname, stname){
	document.getElementById("dcode").value=dcode;
	document.getElementById("dname").value=dname;
	document.getElementById("stname").value=stname;
	document.getreports.action="downloadPDFNRSCProjWorks";
...
function exportExcel(dcode, dname, stname){
	...
	document.getElementById("dname").value=dname;
	document.getElementById("stname").value=stname;
	document.getreports.action="downloadExcelNRSCProjWorks";
	document.getreports.method="post";
	document.getreports.submit();
}
...
<form action = "downloadExcelNRSCProjWorks" method = "post" name = "getreports" id = "getreports">
...
<div class="container-fluid">
	<div class="row">
		<div class="col text-center">
			<div class="offset-md-3 col-6 formheading" style="textl-align: center;">
				<h5>Report GT1- Project-wise Total No. of Work Code Shared with NRSC for Geotagging for District "<c:out value='${dname}'/>" of State "<c:out value='${stname}'/>"</h5>
			</div>
		</div>
	</div>
</div>
	...
	<button name="exportPDF" id="exportPDF" onclick="exportPDF('${dcode}', '${dname}', '${stname}')" class="btn btn-info">PDF</button>
	<p align="right"> Report as on: <%=app.util.Util.dateToString(null,"dd/MM/yyyy hh:mm aaa")%> </p>	


<table id = "tblProjReport" class = "table">
	<thead>
		<tr>
	...
	<tbody id = "nrscProjWorksRptTbody">
		<tr>
		...
		<c:forEach items="${nrscProjWorksList}" var="work" varStatus="sno">
			<tr>
...
<!-- 		</tr> -->
		...
		<c:if test="${nrscProjWorksListSize==0}">
			<tr>
				<td align="center" colspan="27" class="required" style="color:red;"><b>Data Not Found</b></td>
			</tr>
		</c:if>
	</tbody>
</table>
