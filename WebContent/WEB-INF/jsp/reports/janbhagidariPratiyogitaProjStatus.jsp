...
<html>
<title>Project wise Current Status of Watershed Janbhagidari</title>
...
<body>
<br>
<div class="offset-md-3 col-6 formheading" style="text-align:center;"  ><h5><label id="head">Report JP2- Project wise Current Status of Watershed Janbhagidari</label></h5></div>
<br>
<div class ="card">
