...
<title>Report PE9-  District-wise Mid Term Evaluation of Production Details</title>
...
<br>
	<div class="offset-md-3 col-6 formheading" style="text-align:center;">
		<h5>
			<label id="head">Report PE9-  District-wise Mid Term Evaluation of Production Details (Milk, Fodder, Migration from Rural to Urban, Springs Rejuvenated and Persons Benefitted) for State  '<c:out value="${stName}"/>'</label>
		</h5>
	</div>
<br>
	<div class ="card">
