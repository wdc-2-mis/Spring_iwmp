...
<title>Report PE10- State and District wise Mid Term Evaluation of Average Annual Income FPOs, FPO and SHG members</title>
...
<br>
	<div class="offset-md-3 col-6 formheading" style="text-align:center;">
		<h5>
			<label id="head">Report PE10 - State-wise Mid Term Evaluation of Average Annual Income FPOs, FPO and SHG members</label>
		</h5>
	</div>
<br>
	<div class ="card">
...
<br>
	<div class="offset-md-3 col-6 formheading" style="text-align:center;">
		<h5>
			<label id="head">Report PE10 - District-wise Mid Term Evaluation of Average Annual Income FPOs, FPO and SHG members for <c:out value ="${stname}"/></label>
		</h5>
	</div>
<br>
	<div class ="card">
