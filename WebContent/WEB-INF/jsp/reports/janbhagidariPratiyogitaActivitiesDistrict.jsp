...
<html>
<title>Report JP3- District wise Current Status of Watershed Janbhagidari Activities</title>
	<script type="text/javascript"> 
	
	function exportExcel(id, stname){
		document.getElementById("id").value=id;
		document.getElementById("stname").value=stname;
		document.getJanbhagidariActDist.action="ExcelgetdistrictWiseJanbhagidariActivitiesReport";
		document.getJanbhagidariActDist.method="post";
		document.getJanbhagidariActDist.submit();
	}
	...
	function downloadPDF(id, stname)
	{
		document.getElementById("id").value=id;
		document.getElementById("stname").value=stname;
		document.getJanbhagidariActDist.action="getdistrictWiseJanbhagidariActivitiesReportPDF";
		document.getJanbhagidariActDist.method="post";
		document.getJanbhagidariActDist.submit();
...
<body>
<br>
<div class="offset-md-3 col-6 formheading" style="text-align:center;"  ><h5><label id="head">Report JP3- District wise Watershed Janbhagidari Activities Details</label></h5></div>
<br>
<div class ="card">
	...
	<div class="col-1" ></div>
	<div class="col-10" >
	<form action="getJanbhagidariActivitiesStatus" method="post" id="getJanbhagidariActDist" name="getJanbhagidariActDist">
			<div class="form-row">
	...
	<table id="dtBasicExample" cellspacing="0" class="table" >
  	<thead>
  	<tr> 
	 	<th colspan="12" style="text-align:left; ">State Name : <c:out value="${stname}" />   </th>
	</tr>
    	<tr>
  	...
  	<tbody>
		...
		<c:set var="count" value="1" />
		 	...
		 	<tr>
				...
				<td align="right" class="table-primary"><b><fmt:formatNumber type="number" minFractionDigits="2"><c:out value='${villaget/dataListSize}' /></fmt:formatNumber></b></td>
				<td align="right" class="table-primary"><b><fmt:formatNumber type="number" minFractionDigits="2"><c:out value='${ngot/dataListSize}' /></fmt:formatNumber></b></td>
				<td align="right" class="table-primary"><b><fmt:formatNumber type="number" minFractionDigits="2"><c:out value='${corporatet/dataListSize}' /></fmt:formatNumber></b></td>
