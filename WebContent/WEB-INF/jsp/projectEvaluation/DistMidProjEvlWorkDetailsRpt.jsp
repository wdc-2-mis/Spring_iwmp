...
<title>Report PE9 - District-wise Mid Term Project Evaluation</title>
...
<div class="maindiv">
    <div class="offset-md-3 col-6 formheading" style="text-align: center;">
        <h4 style="text-decoration:underline;">Report PE9 - District-wise Mid Term Project Evaluation of Geotagged Work Details</h4>
    </div>
    <br>
    <div class ="card">
		<div class="row">
