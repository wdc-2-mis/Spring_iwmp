...
<div class="col formheading" style="display: flex; align-items: center; justify-content: center;">
	...
	<h4 style="margin: 0;">
		<span style="text-decoration:underline;">Mid Term Project Evaluation - Execution of Planned Works against Targets</span>
	</h4>
</div>
...
<div class="form-group">
	...
	District : &nbsp; <b><c:out value='${distName}' /></b>, &nbsp;&nbsp;&nbsp; Project : &nbsp; <b><c:out value='${projName}' /></b>, &nbsp;&nbsp;&nbsp; 
	Financial Year : &nbsp; <b><c:out value='${finyear}' /></b>, &nbsp;&nbsp;&nbsp; Month : &nbsp; <b><c:out value='${month}' /></b>
</div>
