...
<div class="container mt-2">
 ...
 <ul class="nav nav-tabs">
    <li class="nav-item">
      <a class="nav-link active" id="createPhysicalAnnualActionPlan" data-toggle="tab" href="#approvalRejection">Approval/Rejection of Achievement</a>
    </li>
   
    <li class="nav-item">
      <a class="nav-link" id="viewMovement" data-toggle="tab" href="#movement">View Achievement Detail/ Movement</a>
    </li>
    
    <li class="nav-item">
      <a class="nav-link" id="CompletedAchPlan" data-toggle="tab" href="#completedAchievement">Completed Achievement Plan</a>
    </li>
  ...
  <div id="approvalRejection" class="container tab-pane active"><br>
     <h3>Approval/Rejection of Achievement</h3>
     <hr/>
   ...
   <div id="movement" class="container tab-pane fade"><br>
     <h3>Movement of Physical Achievement</h3>
     <hr/>
 ...
 <div id="completedAchievement" class="container tab-pane fade"><br>
     <h3>Completed Achievement Plan</h3>
     <hr/>
      <table class="completeAchMovement" id="completeAchMovement" name="completeAchMovement">
     <thead><tr><th>Project</th><th>Year</th><th>Status</th><th>Currently at Level</th><th >Remarks</th><th>View Achievement Detail</th></tr></thead>
